...
def upload():
    ...
    if request.method == 'POST':
        ...
        # Get file data and save to your uploads folder
            pict=up_form.pict.data
            file_name=secure_filename(pict.filename)
            pict.save(os.path.join(app.config['UPLOAD_FOLDER'], file_name)) 
...
def files():
    ...
    return render_template('files.html', all_picts=pictures)
